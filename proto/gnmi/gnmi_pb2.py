...
_SUBSCRIBERESPONSEORERROR = _descriptor.Descriptor(
  name='SubscribeResponseOrError',
  full_name='gnmi.SubscribeResponseOrError',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='target_id', full_name='gnmi.SubscribeResponseOrError.target_id', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='subscribe_response', full_name='gnmi.SubscribeResponseOrError.subscribe_response', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='error', full_name='gnmi.SubscribeResponseOrError.error', index=2,
...
_SUBSCRIBERESPONSEORERROR.fields_by_name['subscribe_response'].message_type = _SUBSCRIBERESPONSE
...
DESCRIPTOR.message_types_by_name['SubscribeResponseOrError'] = _SUBSCRIBERESPONSEORERROR
...
SubscribeResponseOrError = _reflection.GeneratedProtocolMessageType('SubscribeResponseOrError', (_message.Message,), {
  'DESCRIPTOR' : _SUBSCRIBERESPONSEORERROR,
  '__module__' : 'proto.gnmi.gnmi_pb2'
  # @@protoc_insertion_point(class_scope:gnmi.SubscribeResponseOrError)
  })
_sym_db.RegisterMessage(SubscribeResponseOrError)
...
_GNMI_REVERSE = _descriptor.ServiceDescriptor(
  name='gNMI_reverse',
  full_name='gnmi.gNMI_reverse',
  file=DESCRIPTOR,
  index=1,
  serialized_options=None,
  create_key=_descriptor._internal_create_key,
  ...
  _descriptor.MethodDescriptor(
    name='Subscribe',
    full_name='gnmi.gNMI_reverse.Subscribe',
    index=0,
    containing_service=None,
    input_type=_SUBSCRIBERESPONSEORERROR,
    output_type=_SUBSCRIBEREQUEST,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
])
_sym_db.RegisterServiceDescriptor(_GNMI_REVERSE)

DESCRIPTOR.services_by_name['gNMI_reverse'] = _GNMI_REVERSE
